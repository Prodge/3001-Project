...
public class Game{
  ...
  public static void main(String[] args){
    Game g = new Game();
    g.stopwatchOn();g.addPlayer(new LearningAgent());g.stopwatchOff(1000,'A');
    g.stopwatchOn();g.addPlayer(new LearningAgent());g.stopwatchOff(1000,'B');
    g.stopwatchOn();g.addPlayer(new LearningAgent());g.stopwatchOff(1000,'C');
